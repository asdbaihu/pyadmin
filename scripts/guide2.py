...
#							update_time timestamp default now() )"""%(y,m,d))
	...
	if post['value'] =='low heel':
		...
		quest ="SKIP sneaker,athletic,low heel, wedges, platform. Pass:đế <=1.5cm, men(1-3cm),sliper,Slip on (trừ đế trắng giống sneaker),bale,Mokassins.Ung di mua van lay <a href='https://172.16.29.6/wsgi/omnivore/demo/FLAT_%20KH_%20traloi_28-Apr-16.htm' target='_blank'>update</a> "
	elif post['value'] =='tunic':
		quest ='Tunic lấy váy thụng có buộc eo như váy xanh trong hướng dẫn'
	elif post['value'] =='sheath':
		quest ='váy bó sát thật là bó,ko lay 2 manh'		
	elif post['value'] =='high heel':
		quest ='PASS (high heel) thể thao, giầy giấu đế(25/04/16)'
	elif post['value'] =='strapless':
		quest ='ko lay bandeur'		
		...
		quest ="""blank=weiß=white, ivory chap nhan duoc la white, trong suot ko phai white ♥ """
	elif post['value']=='yellow':
		quest ="""jaune=yellow """		
	elif post['value']=='blue':
		quest ="""navy=bleu=blue """	
	elif post['value']=='vneck':
		quest ="""cổ ngũ giác không lấy,áo con ko lấy, co co 2 day v lai ok roi"""	
	elif post['value']=='roundneck':
		quest ="""cổ tau = tron, ko lay ao khoac"""		
	elif post['value']=='mini':
		quest ="""lay ca chan vay"""	
	elif post['value']=='roundoval':
		quest ="""ko lay kinh boi, kinh trong suot"""		
	elif post['value']=='maxi':
		quest ="""tinh vat truoc"""			
	else:
		quest=''
	#items = [1, 2, 3, 4, 5, 6, 7]
