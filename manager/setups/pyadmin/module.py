...
headlink += """<script type="text/javascript" src="%s/chart.js"></script>""" % js
...
for row_admin1 in ps_admin_menu1:
    ...
    if len(ps_admin_menu2) > 0:
        menuadmin += """<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href='%s'>%s<b class="caret"></b></a>""" % (
...
for row1 in ps_menu1:
    ...
    ps_menu2 = cur.fetchall()
    if len(ps_menu2) > 0:
        menuuser += """<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href='%s'>%s<b class="caret"></b></a>""" % (
        row1[2], row1[1])
