...
link text,
update_time timestamp default now());
insert into admin_first_menu(link) values('test');
...
link text,
update_time timestamp default now());
insert into admin_second_menu(link) values('test');
...
link text,
update_time timestamp default now());
insert into first_menu(link) values('test');
...
link text,
update_time timestamp default now());
insert into second_menu(link) values('test');
